...
For entity location: Click ok entity picture and select your app on the opened popup

For any point on the map (Windows): Click right mouse button and select your app on the opened popup
